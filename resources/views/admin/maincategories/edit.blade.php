                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.categories.update',$mainCategory -> id)}}"
                                              method="POST"
                                        ...
                                        <div class="tab-content px-1 pt-1">
                                            ...
                                            @isset($mainCategory -> categories)
                                                ...
                                                <div role="tabpanel" class="tab-pane  active   " id="homeLable{{$index}}"
                                                 aria-labelledby="homeLable-tab"
                                                 aria-expanded="true">

                                                <form class="form"
                                                      action="{{route('admin.categories.update',$translation -> id)}}"
                                                      method="POST"
                                                      enctype="multipart/form-data">
                                                    @csrf
